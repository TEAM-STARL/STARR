...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,928337883,928337883}
print("\27[34m"..[[
...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "نجمه") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "نجمه")
local namebot = {
...
os.execute('rm -rf TEAM-STARL.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/tumblr-Source/tumblr-Source/master/TEAM-STARL.lua', 'TEAM-STARL.lua') 
download_to_file('https://raw.githubusercontent.com/tumblr-Source/tumblr-Source/master/start.lua', 'start.lua') 
dofile('TEAM-STARL.lua')  
return false
end
...
⚜┇TEAM STAR
┉ ┉ ┉ ♡ ┉ ┉ ┉
🌐┇[Source Channel](https://t.me/RRRRDO)

👩🏻‍💻┇[Developer](https://t.me/X_X_T)
┉ ┉ ┉ ♡ ┉ ┉ ┉
📧┇[TWS STAR](https://t.me/ts_3bot)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "نجمه")
